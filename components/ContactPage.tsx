...
import vector from '@/public/contact.png'; // replace with your actual image path
...
const fadeIn = fadeUp; // reuse fadeUp as fadeIn since you use it for image and form
...
export default function ContactPage() {
  ...
  const modalRef = useRef<HTMLDivElement>(null); // ✅ Added
  ...
  return (
    <section className="relative py-16 px-6 sm:px-10 bg-[#080d14] text-yellow-100 overflow-hidden min-h-auto mt-12 md:mt-20 max-w-auto">
      {/* Glowing Light */}
      ...
      {formSubmitted && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div
            ref={modalRef}
            className="bg-[#2c2f36] border border-yellow-500/40 shadow-2xl text-white rounded-2xl p-6 max-w-sm w-full text-center relative"
          >
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
        {/* Left Image */}
        <motion.div className="w-full lg:w-1/2" variants={fadeIn} initial="hidden" animate="visible">
          <Image src={vector} alt="Contact Vector" className="w-full h-auto rounded-xl shadow-lg mb-4" />
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 rounded-lg bg-[#2c2f36] text-white border border-gray-700 focus:outline-none"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2 rounded-lg bg-[#2c2f36] text-white border border-gray-700 focus:outline-none resize-none"
              />
            </div>
            ...
            <div>
              <button
                type="submit"
                className="bg-gradient-to-r from-[#bd853c] to-[#e0b86d] hover:from-[#a9752b] hover:to-[#d8af60] text-black font-semibold px-6 py-2 rounded-lg w-full shadow-lg"
              >
                Submit
              </button>
            </div>
