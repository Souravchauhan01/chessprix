...
export default function HallOfFame() {
  ...
  return (
    <section className="relative py-16 sm:mt-18 mt-8 px-6 sm:px-10 bg-gradient-to-br from-[#0a0f1a] via-[#0e131f] to-[#0a0f1a] text-yellow-100 overflow-hidden min-h-auto">
