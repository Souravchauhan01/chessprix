    ...
    <>
      ...
      <div className="relative w-full bg-[#080d14] text-yellow-100 px-6 sm:px-10 py-20 overflow-hidden pt-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            <motion.h1 
              className="text-4xl sm:text-5xl p-2 font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#bd853c] to-[#e0b86d] drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)] mb-4"
              variants={fadeInUp}
              custom={0}
            >
