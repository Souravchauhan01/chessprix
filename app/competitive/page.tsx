...
export default function CompetitivePage() {
  ...
  const programs = [
    {
      title: "FIDE Rating & Tournament Prep",
      rating: "1400 - 1600",
      experience: "Aspiring Competitor: Students who are serious about getting a FIDE rating and competing. They have a solid foundation but need to learn tournament-specific skills.",
      goal: "Master Tournament Skills: To prepare for the psychological and practical challenges of tournament play. This includes time management, notation, using a clock, and understanding the Swiss system format.",
      href: "/fide-rating",
      color: "from-[#D4AF37] to-[#e0b86d]",
      icon: "🏆"
    },
    {
      title: "The Master's Path: Elite Training & Rating Booster",
      rating: "1600+",
      experience: "Experienced & Ambitious: Students with a FIDE rating who are serious about breaking rating plateaus. They have a strong foundation but lack a systematic approach to in-game thinking.",
      goal: "Implement a GM-Level Thinking System: To move beyond memorization and develop a structured, systematic process for every stage of the game. The focus is on a deeper understanding of strategy, calculation, and positional evaluation.",
      href: "/masters-path",
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.p
              ...
              custom={1}
            >
              Elite training programs for serious competitors and aspiring masters
            </motion.p>
            <motion.div
          ...
          >
            <p className="text-yellow-200/80 mb-6">
              Choose the program that matches your competitive goals
            </p>
            <Link
              href="/fide-rating"
            ...
            >
              <span>Start Your Competitive Journey</span>
